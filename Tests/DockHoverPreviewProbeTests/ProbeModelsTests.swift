...
final class ProbeModelsTests: XCTestCase {
    ...
    func testThumbnailCacheKeyIncludesFrameSizeAndTitle() {
        ...
        let key = ThumbnailCacheKey(id: id, captureFrame: CGRect(x: 0, y: 0, width: 640, height: 480), title: "One")
        let changedTitle = ThumbnailCacheKey(id: id, captureFrame: CGRect(x: 0, y: 0, width: 640, height: 480), title: "Two")
