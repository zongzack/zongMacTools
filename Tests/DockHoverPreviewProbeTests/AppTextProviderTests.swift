...
final class AppTextProviderTests: XCTestCase {
    func testEnglishMenuStrings() {
        ...
        XCTAssertEqual(provider.string(.addExcludedApp), "Add...")
        XCTAssertEqual(provider.string(.chooseAppToExclude), "Choose App to Exclude")
    ...
    func testSimplifiedChineseMenuStrings() {
        ...
        XCTAssertEqual(provider.string(.addExcludedApp), "\u{6DFB}\u{52A0}...")
        XCTAssertEqual(provider.string(.chooseAppToExclude), "\u{9009}\u{62E9}\u{8981}\u{6392}\u{9664}\u{7684} App")
