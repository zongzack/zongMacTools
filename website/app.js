...
const messages = {
  zh: {
    ...
    originsEyebrow: "Windows → macOS",
    originsTitle: "把熟悉的操作，重新做成 Mac 工具",
    originsSummary:
      "Windows 上有些高频交互已经证明好用；zongMacTools 挑选其中值得带来的部分，遵循 macOS 的窗口、权限和交互习惯重新实现。",
    migrationTag: "Windows 任务栏",
    migrationTitle: "悬停预览窗口 → Dock 窗口速览",
    migrationCopy: "Windows 任务栏可以悬停查看同一应用的窗口。Dock Window Quick Look 将这个交互带到 macOS：停在 Dock 图标上，查看窗口、切换前景并使用当前可用的窗口操作。",
    gainTag: "Windows 资源管理器",
    gainTitle: "右键新建文件 → Finder 新建文件",
    gainCopy: "资源管理器空白处右键新建文件，是一个熟悉的工作流。我们正在把它按照 Finder 的使用方式重新实现。",
    toolEyebrow: "Windows 体验迁移 · 已实现",
    toolTitle: "Dock Window Quick Look（Dock 窗口速览）",
    implementedStatus: "已实现",
    toolSummary: "Windows 任务栏可以悬停查看应用窗口。现在，停在 macOS Dock 上正在运行的应用图标，也能查看当前窗口并快速切换。",
    demoLabel: "交互原理演示：Windows 任务栏预览的 macOS 重做",
    demoBadge: "交互预览 · 展示窗口预览、切换和操作路径",
    demoStepsLabel: "Dock 窗口速览步骤控制器",
    demoStepsIntro: "按步骤看看这个熟悉交互如何来到 Mac：",
    stageDock: "停在 Dock",
    stageWindows: "查看窗口",
    stageSwitch: "切换窗口",
    stageActions: "窗口操作",
    ...
    toolMediaLink: "查看真实运行画面",
    mediaEyebrow: "迁移后的真实运行画面",
    mediaTitle: "Windows 任务栏预览，来到 macOS Dock",
    mediaSourceMark: "本地录屏",
    mediaCopy:
      "下面的本地录屏展示 Windows 用户熟悉的窗口预览如何在 macOS Dock 上工作，覆盖停在 Dock、预览出现、选择窗口卡片与打开右键窗口操作菜单。",
    mediaVideoLabel: "Dock Window Quick Look 本地录屏，展示窗口预览、切换和操作",
    mediaPosterAlt: "本地录屏海报帧：Dock 预览卡片旁打开窗口操作菜单",
    mediaCaption: "本地录屏：悬停 Dock、预览出现、选择窗口与窗口操作。",
    ...
    explorationEyebrow: "下一项 Windows 体验",
    explorationTitle: "资源管理器右键新建文件 → Finder",
    buildingStatus: "开发中",
    explorationCopy:
    ...
    acquireCopy: "公开测试版的下载、版本和安装说明都在 GitHub Release 中提供。需要获取最新版本时，请直接打开 GitHub 发行详情。",
    acquireLoading: "正在检查最新公开版本…",
    acquirePending: "目前还没有可验证的公开下载版本，请前往 GitHub 查看最新状态。",
    acquireUnavailable: "暂时无法读取 GitHub 的版本信息，请直接打开 GitHub 查看最新状态。",
    ...
    footerCopy: "把 Windows 上值得留下的桌面体验，重做成 macOS 工具。",
    privacyCopy: "本站为无数据站点：不收集个人数据，不使用 Cookie、分析或第三方媒体服务。"
  },
  en: {
    title: "zongMacTools | Bringing familiar Windows desktop features to Mac",
    description:
      "zongMacTools rebuilds familiar Windows desktop interactions around macOS conventions. Its first tool brings taskbar-style window previews to the Mac Dock.",
    ogDescription: "From taskbar window previews to creating new files from Finder's context menu, zongMacTools rebuilds useful Windows desktop experiences for macOS.",
    ogLocale: "en_US",
    skipLink: "Skip to main content",
    primaryNavigation: "Primary navigation",
    homeLink: "zongMacTools home",
    toolNav: "Migration cases",
    ...
    heroEyebrow: "Windows → macOS",
    heroStatement: "Bring familiar Windows desktop features to the Mac.",
    heroSummary:
      "zongMacTools rebuilds familiar, high-frequency Windows desktop interactions around macOS conventions. It keeps the useful experience, not the copied interface.",
    heroAction: "See the first migration",
    heroHint: "Scroll to see which Windows experiences are making their way to the Mac.",
    originsEyebrow: "Windows → macOS",
    originsTitle: "Familiar workflows, rebuilt for the Mac",
    originsSummary:
      "Some Windows interactions have already proved useful. zongMacTools selects the ones worth bringing over and rebuilds them around macOS windows, permissions, and interaction patterns.",
    migrationTag: "Windows taskbar",
    migrationTitle: "Hover window previews → Dock Window Quick Look",
    migrationCopy:
      "Windows taskbar previews show the windows inside an app. Dock Window Quick Look brings that interaction to macOS: pause on a Dock icon to inspect windows, switch to the foreground, and use the actions available today.",
    gainTag: "Windows File Explorer",
    gainTitle: "Right-click to create files → Finder",
    gainCopy:
      "Creating a new file from empty space in File Explorer is a familiar workflow. We are rebuilding it around the way Finder works.",
    toolEyebrow: "Windows experience migration · Implemented",
    toolTitle: "Dock Window Quick Look",
    implementedStatus: "Implemented",
    toolSummary:
      "Windows taskbar previews show an app's open windows. On macOS, pause on a running Dock icon to see its current windows and switch quickly.",
    demoLabel: "Interaction principle demonstration: taskbar window previews rebuilt for macOS",
    demoBadge: "Interaction preview · window preview, switching, and actions",
    demoStepsLabel: "Dock Window Quick Look step controls",
    demoStepsIntro: "See how this familiar interaction works on the Mac:",
    ...
    toolMediaLink: "See the real running footage",
    mediaEyebrow: "The migrated experience in action",
    mediaTitle: "Windows taskbar previews, rebuilt for the Mac Dock",
    mediaSourceMark: "LOCAL RECORDING",
    mediaCopy:
      "This local recording shows familiar Windows window previews working on the macOS Dock: pausing on the Dock, the preview appearing, selecting a window card, and opening the window actions menu.",
    mediaVideoLabel: "Dock Window Quick Look local recording showing window previews, switching, and actions",
    mediaPosterAlt: "Local recording poster frame: window actions menu open beside Dock preview cards",
    mediaCaption: "Local recording: Dock hover, preview appearing, window switching, and window actions.",
    ...
    explorationEyebrow: "Next Windows experience",
    explorationTitle: "File Explorer right-click → Finder",
    buildingStatus: "In development",
    explorationCopy:
      "Windows File Explorer lets you right-click empty space in a folder to create a new file. We are bringing that workflow to macOS around the way Finder works, with the goal of creating common local files such as Markdown and JSON; progress will be shared on GitHub.",
    ...
    acquireCopy:
      "The public beta download, version, and installation details are provided on GitHub Releases. Open the GitHub release details for the latest version.",
    acquireLoading: "Checking the latest public version…",
    acquirePending: "There is no verifiable public download version yet. Visit GitHub for the latest status.",
    acquireUnavailable: "GitHub version information is temporarily unavailable. Open GitHub for the latest status.",
    ...
    footerCopy: "Useful Windows desktop experiences, rebuilt as macOS tools.",
