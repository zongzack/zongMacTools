...
[[ -f "$RESOURCE_BUNDLE/BlankWord.zip" ]] || fail "missing embedded Word template"
[[ -f "$RESOURCE_BUNDLE/BlankExcel.zip" ]] || fail "missing embedded Excel template"
[[ -f "$RESOURCE_BUNDLE/BlankPowerPoint.zip" ]] || fail "missing embedded PowerPoint template"
