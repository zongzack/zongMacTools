...
- Main evidence:
  ...
  - Other normal Space: pass after follow-up tuning; 2026-06-30 and 2026-07-01 runs on a second normal desktop showed hover previews, thumbnail success, stale cancellation logs, Escape dismissal, card activation, and Dock restart recovery. A first-pass concern where the panel hid too easily between Dock and preview was fixed by narrowing the preview retention geometry to Dock, panel, and a bridge region; 2026-07-01 user retest reported the interaction felt normal. A follow-up concern where the previous app preview stayed visible after moving to an adjacent non-running Dock app was fixed by limiting Dock hover-lost retention to the panel and Dock-panel bridge transition region; 2026-07-01 user retest reported the behavior normal.
- Remaining risks:
  - Full-screen Spaces, Stage Manager, Dock auto-hide, left/right Dock, and multiple displays remain unverified in the MVP UI pass.
